...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseStorage.getInstance().getReference().child("data").listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(GalleryActivity.this, "Failed to retrieve images", Toast.LENGTH_SHORT).show();
            }
        });
    }
